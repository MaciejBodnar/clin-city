...
@section('content')
    <main class="min-h-screen bg-[#f3eee7]">
            ...
            <section
                ...
                <div class="relative">
                    <div class="absolute inset-0">
                        <img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/welcome-hero.jpg'); ?>" alt="" class="h-full w-full object-cover" />
                    ...
                    <div
                        class="relative flex min-h-[560px] flex-col items-center justify-center px-6 pb-10 pt-14 text-center sm:min-h-[640px]">
                   ...
                   sm:text-[92px] md:text-[120px]"
                            ...
                            <span class="inline-flex items-end gap-1">
                                ...
                                <span class="inline-block translate-y-[6px]" aria-hidden="true">
              ...
              ?>
                                <li>
                                    <a href="/home/" class="hover:text-white/90 transition">
